 ...
 *
 * @property id         程序模块标识
 * @property moduleName 程序模块名称
 * @property appType    程序类型，01表示 web，02表示 android，03表示 ios，04表示微信小程序，05表示支付宝小程序
 *
 */
 ...
 * 程序模块模型
 *
 * @property moduleInfo     模块基本信息
 * @property widgets        组成页面的通用部件列表
 * @property instWidgets    组成页面的实例部件列表
 */
export interface ModuleModel {
	moduleInfo: ModuleInfo;
	widgets: AttachedUIWidget[];
	instWidgets: UIInstWidget[];
	// TODO: 数据服务模型（逻辑处理模型）
}
